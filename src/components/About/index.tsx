                ...
                <Col lg={6}>
                  <ul>
                    <li className="about-item">
                      <KeyboardArrowRight className="about-item-icon" />{" "}
                      <strong>Birthday:</strong>{" "}
                      <span>{myProfile.birthday}</span>
                    </li>
                    <li className="about-item">
                      <KeyboardArrowRight className="about-item-icon" />{" "}
                      <strong>Phone:</strong> <span>{myProfile.phone}</span>
                    </li>
                    <li className="about-item">
                      <KeyboardArrowRight className="about-item-icon" />{" "}
                      <strong>City:</strong> <span>{myProfile.address}</span>
                    </li>
                  </ul>
                </Col>
                <Col lg={6}>
                  <ul>
                    <li className="about-item">
                      <KeyboardArrowRight className="about-item-icon" />{" "}
                      <strong>Age:</strong> <span>{myProfile.age}</span>
                    </li>
                    <li className="about-item">
                      <KeyboardArrowRight className="about-item-icon" />{" "}
                      <strong>Email:</strong> <span>{myProfile.email}</span>
                    </li>
                  </ul>
                </Col>
              </Row>
            </div>
            <p className="about-slogan">{myProfile.slogan}</p>
          </Col>
        </Row>
      </Container>
    </section>
